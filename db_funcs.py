...
def add_contact_mode(val_tabl_contacts, val_tabl_numbers, phone_book=get.get_db()):
...
def exit(phone_book=get.get_db()):
    """Закрывает контакт к БД"""
    phone_book.close()
    return True

def show_book(phone_book=get.get_db()):
...
def del_contact(id_for_del, phone_book=get.get_db()):
...
def search_by_surname(phone_book=get.get_db()):
...
def search_by_name(phone_book=get.get_db()):
...
def search_by_father_name(phone_book=get.get_db()):
...
def search_by_email(phone_book=get.get_db()):
...
def search_by_number(phone_book=get.get_db()):
...
def serach_by_home_number(phone_book=get.get_db()):
...
def search_by_work_number(phone_book=get.get_db()):
...
def edit_surname(new_surname, id_for_edit, phone_book=get.get_db()):
...
def edit_name(new_name, id_for_edit, phone_book=get.get_db()):
...
def edit_father_name(new_father_name, id_for_edit, phone_book=get.get_db()):
...
def the_same_email(new_email, id_for_edit, phone_book=get.get_db()):
...
def edit_email(new_email, id_for_edit, phone_book=get.get_db()):
...
def edit_number(new_number, id_for_edit, phone_book=get.get_db()):
...
def edit_home_number(new_home_number, id_for_edit, phone_book=get.get_db()):
...
def edit_work_number(new_work_number, id_for_edit, phone_book=get.get_db()):
